...
Skill resolution itself is delegated to the pinned `skills@1.7.0` CLI with prompts suppressed — the trust decisions all happen in the layers above, not in the delegated fetch.
